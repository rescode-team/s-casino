...
Route::namespace('Frontend')->middleware(['siteisclosed', 'checker'])->group(function () {
    ...
    */
    Route::get('tournament', ['as' => 'frontend.gournament.list', 'uses' => 'GamesController@go_tournament']);
    ...
    Route::get('/get_tournament_order', ['as' => 'frontend.tournaments.order', 'uses' => 'TournamentsController@order']);
    Route::get('/countResult', ['as' => 'frontend.tournaments.countResult', 'uses' => 'TournamentsController@countResult']);
    Route::get('/get_user_balance', ['as' => 'frontend.tournaments.getUserBalance', 'uses' => 'TournamentsController@getUserBalance']);
    Route::get('/getJackpot',['as'=>'frontend.getJackpot','uses'=> 'GamesController@getJackpot']);
